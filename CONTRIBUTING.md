# Contributing to Tentacular Projects

Thanks for your interest in contributing to Tentacular and help improve the project! ⚡️✨

This document explains the common procedures expected by contributors while submitting code to Tentacular projects.
...
We welcome suggestions to improve the Tentacular project. To ensure a smooth and collaborative process, please follow these steps:
...
Identify which part of Tentacular interests you for contributing before starting your contribution journey. Users are requested to raise GitHub issues specific to the repositories you are contributing to.
...
Tentacular Project uses Developer Certificate of Origin ([DCO](https://github.com/apps/dco/)).
