# docs-deployment-guide Specification

## Purpose
Requirements for the deployment guide documentation to reflect the new two-phase build/deploy workflow with ConfigMap code delivery.
